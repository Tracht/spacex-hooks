      ...
      <Modal>
        <ModalContent>
          <ModalHeader data-cy="item-name">
            {activeSelection.core_serial}
          </ModalHeader>

          <ModalTitle green data-cy="background">
            Background
          </ModalTitle>
          ...
          {activeSelection.original_launch ? (
            <ModalText data-cy="launch-true">
              Original launch: {activeSelection.original_launch}
            </ModalText>
          ) : (
            <ModalText data-cy="launch-false">
              Original launch: Has not been launched.
            </ModalText>
          )}
          ...
          {activeSelection.missions ? (
            <ModalTitle green> Missions </ModalTitle>
          ) : null}
