      ...
      <Modal>
        <ModalContent>
          ...
          {activeSelection.crew_capacity ? (
            <ModalText>
              Crew capacity: {activeSelection.crew_capacity}
            </ModalText>
          ) : (
          ...
          {activeSelection.dry_mass_kg && activeSelection.dry_mass_lb && (
            <ModalText>
              Dry mass: {activeSelection.dry_mass_kg}kg /
              {activeSelection.dry_mass_lb}lbs
            </ModalText>
          )}
          {activeSelection.orbit_duration_yr ? (
            <ModalText>
              Duration in orbit: {activeSelection.orbit_duration_yr} years
            </ModalText>
          ) : (
            <ModalText> Duration in orbit: No information provided </ModalText>
          )}
          {activeSelection.first_flight ? (
            <ModalText>First flight: {activeSelection.first_flight}</ModalText>
          ) : (
            <ModalText> First flight: No information provided </ModalText>
          )}

          {activeSelection.heat_shield ? (
            <ModalTitle green> Heat Shield </ModalTitle>
          ) : null}
          {activeSelection.heat_shield.material ? (
            <ModalText>
              Material: {activeSelection.heat_shield.material}
            </ModalText>
          ) : (
          ...
          {activeSelection.heat_shield.size_meters ? (
            <ModalText>
              Size: {activeSelection.heat_shield.size_meters} meters
            </ModalText>
          ) : (
          ...
          {activeSelection.heat_shield.temp_degrees ? (
            <ModalText>
              Max temperature: {activeSelection.heat_shield.temp_degrees} C
            </ModalText>
          ) : (
          ...
          {activeSelection.heat_shield.dev_partner ? (
            <ModalText>
              Development Partner: {activeSelection.heat_shield.dev_partner}
            </ModalText>
          ) : (
          ...
          {activeSelection.thrusters ? (
            <ModalTitle green> Thrusters </ModalTitle>
          ) : null}
          {activeSelection.thrusters ? (
          ...
          {activeSelection.wikipedia ? (
            <ModalTitle green center>
              Learn more
            </ModalTitle>
          ) : null}
          {activeSelection.wikipedia && (
            <Link href={activeSelection.wikipedia}> Wikipedia </Link>
          )}
          ...
          <Button
            green
            onClick={keepOpenActiveSelection}
            type="submit"
            data-cy="close-modal"
          >
            Close
