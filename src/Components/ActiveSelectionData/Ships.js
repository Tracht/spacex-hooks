      ...
      <Modal>
        <ModalContent>
          <ModalHeader data-cy="item-name">
            {activeSelection.ship_name}
          </ModalHeader>
          {activeSelection.image && (
            <ModalImage
              src={activeSelection.image}
              alt={activeSelection.ship_name}
              width="300"
              height="250"
            ></ModalImage>
          )}
          ...
          {activeSelection.successful_landings ? (
            <ModalText>
              Successful landings: {activeSelection.successful_landings}
            </ModalText>
          ) : (
          ...
          {activeSelection.attempted_landings ? (
            <ModalText>
              Attempted landings: {activeSelection.attempted_landings}
            </ModalText>
          ) : (
          ...
          {activeSelection.roles ? (
            <ModalTitle green> Roles </ModalTitle>
          ) : null}
          {activeSelection.roles ? (
          ...
          {activeSelection.url && (
            <Link href={activeSelection.url}> Website </Link>
          )}
          <br></br>
          <Button
            green
